 ...
 * interfaces without having to sacrifice [privacy
 ...
 * (only receives commands, replies to its messages and mentions). There could
 * be two ways to create a new poll:
 ...
 * answer options, then send /done when you're ready'. The last option is
 * definitely more attractive. And if you use ForceReply in your bot's
 * questions, it will receive the user's answers even if it only receives
