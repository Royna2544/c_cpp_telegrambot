...
#include <string>
#include <vector>
#include <api/types/KeyboardButton.hpp>

namespace api::types {

/**
 * @brief This object represents a [custom
 * keyboard](https://core.telegram.org/bots/features#keyboards) with reply
 * options (see [Introduction to
 * bots](https://core.telegram.org/bots/features#keyboards) for details and
 * examples).
 */
