...
#include <api/types/SwitchInlineQueryChosenChat.hpp>
#include <cstdint>
#include <optional>
#include <string>
...
struct InlineKeyboardButton {
     ...
     * identifier without using a username, if this is allowed by their privacy
     * settings.
     */
    std::optional<std::string> url;

    /**
     * @brief Optional. Data to be sent in a [callback
     * query](https://core.telegram.org/bots/api#callbackquery) to the bot when
     * button is pressed, 1-64 bytes
     */
    std::optional<std::string> callbackData;

    /**
     * @brief Optional. Description of the [Web
     * App](https://core.telegram.org/bots/webapps) that will be launched when
     * the user presses the button.
     *
     * The Web App will be able to send an arbitrary message on behalf of the
     * user using the method Api::answerWebAppQuery. Available only in private
     * chats between a user and the bot.
     * 
     * API_REMOVED: Unused in this project [SubCategories.WebApp].
     * FieldType: WebAppInfo
     * FieldName: webApp
     */
     ...
     * 
     * API_REMOVED: Unused in this project [SubCategories.Login].
     * FieldType: LoginUrl
     * FieldName: loginUrl
     */
    ...
    /**
     * @brief Optional. If set, pressing the button will prompt the user to
     * select one of their chats of the specified type, open that chat and
     * insert the bot's username and the specified inline query in the input
     * field
     */
    std::optional<SwitchInlineQueryChosenChat> switchInlineQueryChosenChat;
     ...
     * FieldType: CallbackGame
     * FieldName: callbackGame
     */

    /**
     * @brief Optional. Specify True, to send a [Pay
