...
struct ReplyKeyboardRemove {
     ...
     * able to summon this keyboard; if you want to hide the keyboard from sight
     * but keep it accessible, use oneTimeKeyboard in ReplyKeyboardMarkup)
     */
    bool removeKeyboard;
     ...
     * poll, bot returns confirmation message in reply to the vote and removes
