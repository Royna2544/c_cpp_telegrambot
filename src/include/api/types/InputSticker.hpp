...
struct InputSticker {
     ...
     *
     * Pass a fileId as a String to send a file that already exists on the
    ...
    /**
     * @brief Format of the added sticker, must be one of “static” for a .WEBP
     * or .PNG image, “animated” for a .TGS animation, “video” for a WEBM video
     */
    std::string format;
    ...
    /**
     * @brief Optional. List of 0-20 search keywords for the sticker with total
