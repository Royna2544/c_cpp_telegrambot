...
class TgBotApi {
   public:
    ...
    using StringOrMessage = std::variant<std::string, std::optional<api::types::Message>>;
     ...
     */
    enum class StickerType { Regular, Mask, CustomEmoji };
   ...
   protected:
    ...
    virtual std::optional<api::types::Message> sendMessage_impl(
        ...
        std::optional<api::types::ReplyParameters> replyParameters = std::nullopt,
        std::optional<api::types::GenericReply> replyMarkup = std::nullopt,
        const ParseMode parseMode = {}) const = 0;

    /**
     * @brief Sends an animation (GIF or video without sound) to the specified chat.
     *
     ...
     * @param animation The content of the animation to be sent (file or file ID).
     * @param caption (Optional) The caption for the animation.
     * @param replyParameters (Optional) Reply parameters for the message.
     * @param replyMarkup (Optional) An inline keyboard markup or generic reply
     * markup to be added to the message.
     * @param parseMode (Optional) The parse mode for the caption. Default is None.
     *
     * @return An optional Message object representing the sent animation message.
     */
    ...
    virtual std::optional<api::types::Message> sendSticker_impl(
        ...
        std::optional<api::types::ReplyParameters> replyParameters = std::nullopt) const = 0;
     ...
     *
     * @return True if the sticker set was created successfully, false otherwise.
     */
     ...
     * @param parseMode (Optional) The parse mode for the new text. Default is None.
     *
    ...
    virtual std::optional<api::types::Message> editMessage_impl(
        ...
        const api::types::InlineKeyboardMarkup& markup,
        const ParseMode parseMode) const = 0;
     ...
     *
     * @param message The message to be edited (inline message ID or Message object).
     * @param markup The new inline keyboard markup for the message.
     *
     * @return An optional Message object representing the edited message.
     */
     ...
     *
     * @param fromChatId The ID of the chat from which the message will be copied.
     * @param messageId The ID of the message to be copied.
     * @param replyParameters (Optional) Reply parameters for the copied message.
     *
     * @return The message ID of the copied message.
     */
    virtual api::types::Message::messageId_type copyMessage_impl(
        api::types::Chat::id_type fromChatId, api::types::Message::messageId_type messageId,
        std::optional<api::types::ReplyParameters> replyParameters = std::nullopt) const = 0;
     ...
     * @param showAlert (Optional) Whether to show an alert to the user. Default is false.
     *
     * @return True if the callback query was answered successfully, false otherwise.
     */
     ...
     */
    virtual void deleteMessage_impl(const std::optional<api::types::Message>& message) const = 0;
    ...
    virtual void deleteMessages_impl(
        api::types::Chat::id_type chatId, const std::vector<api::types::Message::messageId_type>& messageIds) const = 0;

    /**
     * @brief Restricts a chat member's permissions.
     *
     * This function restricts or mutes a chat member by setting new permissions.
     *
     * @param chatId The ID of the chat.
     * @param userId The ID of the user to be restricted.
     * @param permissions The new permissions for the restricted user.
     * @param untilDate (Optional) The timestamp until the user will be restricted.
     * If not specified, the restriction is permanent.
     */
    virtual void restrictChatMember_impl(
        api::types::Chat::id_type chatId, api::types::User::id_type userId, api::types::ChatPermissions permissions,
        std::chrono::system_clock::time_point untilDate = {}) const = 0;

    /**
     * @brief Sends a document file to the specified chat.
     *
     * This function sends a document file to the chat with the given parameters.
     *
     ...
     * @param parseMode (Optional) The parse mode for the caption. Default is None.
     *
     * @return An optional Message object representing the sent document message.
     */
     ...
     */
    virtual std::optional<api::types::Message> sendDice_impl(api::types::Chat::id_type chatId) const = 0;
     ...
     *
     * @param destFilename The destination filesystem path for the downloaded file.
     ...
     */
    virtual bool pinMessage_impl(std::optional<api::types::Message> message) const = 0;
     ...
     */
    virtual bool unpinMessage_impl(std::optional<api::types::Message> message) const = 0;
     ...
     *
     * This function removes the ban from a user, allowing them to rejoin the chat.
     *
     * @param chat The chat from which the user will be unbanned.
     * @param user The user to be unbanned.
     *
     * @return True if the chat member was unbanned successfully, false otherwise.
     */
     ...
     */
    virtual std::optional<api::types::User> getChatMember_impl(const api::types::Chat::id_type chat,
     ...
     *
     * @note The descriptions provide context or information about the bot to users.
     */
     ...
     *
     * @param chatId The unique identifier of the chat where the message resides.
    ...
    virtual bool setMessageReaction_impl(
        api::types::Chat::id_type chatId, api::types::Message::messageId_type messageId,
        const std::vector<api::types::ReactionType>& reaction, bool isBig) const = 0;
    ...
    * @return An optional Chat object representing the chat information.
     ...
     *
     * @return A FileOrString variant containing either an InputFile or file ID string.
     */
   ...
   public:
     ...
     *
     * This compile-time function converts a ParseMode value to the corresponding
     * string used by the Telegram Bot API.
     *
     ...
     *
     * This overload uses the message object to extract chat and thread information
    ...
    std::optional<api::types::Message> sendReplyMessage(
        const api::types::Message& replyToMessage, const std::string_view message,
        const std::optional<api::types::GenericReply> replyMarkup = std::nullopt) const {
    ...
    template <ParseMode mode = ParseMode::None>
    std::optional<api::types::Message> sendReplyMessage(
        const api::types::Chat::id_type chatId, const api::types::Message::messageId_type messageId,
        const std::optional<api::types::Message::messageThreadId_type> messageTid,
     ...
     */
    template <ParseMode mode = ParseMode::None>
    std::optional<api::types::Message> sendMessage(const ChatIds& chatId,
                             const std::string_view message,
        const std::optional<api::types::GenericReply> markup =
            std::nullopt) const {
     ...
     * @param replyToMessage The message to which the animation will be sent as a reply.
     ...
     */
    template <ParseMode mode = ParseMode::None>
    std::optional<api::types::Message> sendReplyAnimation(const std::optional<api::types::Message>& replyToMessage,
     ...
     */
    template <ParseMode mode = ParseMode::None>
    std::optional<api::types::Message> sendAnimation(const ChatIds& chatid,
                               const FileOrMedia& mediaId,
                               const std::string_view caption = {}) const {
     ...
     *
     * @param replyToMessage The message to which the sticker will be sent as a reply.
     * @param sticker The sticker file or file ID to be sent.
     *
     * @return An optional Message object representing the sent sticker message.
     */
    std::optional<api::types::Message> sendReplySticker(const std::optional<api::types::Message>& replyToMessage,
     ...
     *
     * @param replyToMessage The message to which the video will be sent as a reply.
     * @param video The video file or file ID to be sent.
     * @param caption (Optional) Caption for the video.
     *
     * @return An optional Message object representing the sent video message.
     */
    std::optional<api::types::Message> sendReplyVideo(const std::optional<api::types::Message>& replyToMessage,
     ...
     * @return An optional Message object representing the sent sticker message.
     */
    std::optional<api::types::Message> sendSticker(const ChatIds& chatId,
    ...
    std::optional<api::types::Message> editMessage(
        const std::optional<api::types::Message>& message, const std::string_view newText,
        const std::optional<api::types::InlineKeyboardMarkup> markup = std::nullopt) const {
     ...
     *
     * @param message The message to be edited (message object or inline message ID).
     * @param replyMarkup The new reply markup for the message.
     *
     * @return An optional Message object representing the edited message.
     */
    inline std::optional<api::types::Message> editMessageMarkup(
        const StringOrMessage& message,
     ...
     * @return The message ID of the copied message.
     */
    inline api::types::Message::messageId_type copyAndReplyAsMessage(const std::optional<api::types::Message>& message) const {
     ...
     * @param replyToMessage The message to which the copied message will be sent as a reply.
     *
     * @return The message ID of the copied message.
     */
    inline api::types::Message::messageId_type copyAndReplyAsMessage(
        const std::optional<api::types::Message>& message, const std::optional<api::types::Message>& replyToMessage) const {
     ...
     * @param showAlert (Optional) Whether to show an alert dialog. Default is false.
     *
     ...
     */
    inline void deleteMessage(const std::optional<api::types::Message>& message) const {
     ...
     */
    inline void deleteMessages(api::types::Chat::id_type chatid,
                               const std::vector<api::types::Message::messageId_type>& messages) const {
     ...
     *
     * This function restricts what a user can do in a chat for a specified duration.
     *
     * @param chatId The ID of the chat.
     ...
     */
    template <ParseMode mode = ParseMode::None>
    std::optional<api::types::Message> sendDocument(ChatIds chatId, FileOrMedia document,
                              const std::string_view caption = {},
                              std::optional< api::types::GenericReply> replyMarkup = std::nullopt) const {
     ...
     *
     * This function sends a photo to a chat with optional caption and reply parameters.
     *
     * @tparam mode The parse mode for the caption. Default is None.
     * @param chatId The ID of the chat to which the photo will be sent.
     ...
     */
    template <ParseMode mode = ParseMode::None>
    std::optional<api::types::Message> sendPhoto(ChatIds chatId, FileOrMedia photo,
                           const std::string_view caption = {},
                           std::optional<api::types::ReplyParameters> replyParameters = std::nullopt,
                           std::optional< api::types::GenericReply> replyMarkup = std::nullopt) const {
     ...
     *
     * This function sends a video to a chat with optional caption and reply parameters.
     *
     * @tparam mode The parse mode for the caption. Default is None.
     * @param chatId The ID of the chat to which the video will be sent.
     * @param video The video file or file ID to be sent.
     ...
     */
    template <ParseMode mode = ParseMode::None>
    std::optional<api::types::Message> sendVideo(ChatIds chatId, FileOrMedia video,
                           const std::string_view caption = {},
                           std::optional<api::types::ReplyParameters> replyParameters = std::nullopt,
                           std::optional< api::types::GenericReply> replyMarkup = std::nullopt) const {
     ...
     *
     * @tparam mode The parse mode for the caption. Default is None.
     * @param replyToMessage The message to which the photo will be sent as a reply.
     * @param photo The photo file or file ID to be sent.
     * @param caption (Optional) Caption for the photo.
     *
     * @return An optional Message object representing the sent photo message.
     */
    template <ParseMode mode = ParseMode::None>
    std::optional<api::types::Message> sendReplyPhoto(const std::optional<api::types::Message>& replyToMessage,
     ...
     */
    [[nodiscard]] inline std::optional<api::types::User> getBotUser() const {
     ...
     * @return An optional Message object representing the sent dice message.
     */
    inline std::optional<api::types::Message> sendDice(const api::types::Chat::id_type chat) const {
     ...
     */
    [[nodiscard]] inline api::types::StickerSet getStickerSet(
     ...
     * @param stickerFormat The format of the sticker (static, animated, or video).
     *
     * @return An optional File object representing the uploaded sticker file.
     */
    [[nodiscard]] inline std::optional<api::types::File> uploadStickerFile(
        std::int64_t userId, api::types::InputFile sticker,
     ...
     * @return True if the message was pinned successfully, false otherwise.
     */
    inline bool pinMessage(std::optional<api::types::Message> message) {
     ...
     * @return True if the message was unpinned successfully, false otherwise.
     */
    inline bool unpinMessage(std::optional<api::types::Message> message) {
     ...
     */
    inline bool banChatMember(const api::types::Chat& chat, const std::optional<api::types::User>& user) {
     ...
     */
    inline bool unbanChatMember(const api::types::Chat& chat,
     ...
     */
    inline std::optional<api::types::User> getChatMember(
        const api::types::Chat::id_type chat, const api::types::User::id_type user) {
    ...
    inline bool setMessageReaction(
        ...
        const std::vector<api::types::ReactionType>& reaction, bool isBig) const {
    ...
    using AnyMessageCallback =
        std::function<AnyMessageResult(TgBotApi::CPtr, const api::types::Message&)>;

    /**
     * @brief Registers a callback for all incoming messages.
     *
     * This virtual function registers a handler to be called for every incoming message.
     *
    ...
    virtual void onCallbackQuery(
        std::string message, CallbackQueryCallback listener) {
        // Dummy implementation
    }
    ...
    struct InlineQuery {
        ...
        std::string command;          ///< Associated command name (empty if not a command)
        bool hasMoreArguments;        ///< Whether the query expects additional arguments
     ...
     *
     * This virtual function registers an inline query handler with a fixed result.
     *
     ...
     *
     * This virtual function registers an inline query handler with a dynamic callback.
     *
     * @param query The inline query configuration.
   ...
   protected:
    ...
    static api::types::ReplyParameters createReplyParameters(
        ...
        api::types::Message::messageId_type messageId = messageToReply->messageId;
     ...
     */
    static api::types::ReplyParameters createReplyParameters(
        api::types::Message::messageId_type messageId, std::optional<api::types::Message::messageThreadId_type> messageThreadId) {
    ...
    virtual void registerCommandListener(const std::string& command, std::function<void(api::types::Message message)> listener) {
        // Dummy implementation
    }
};
