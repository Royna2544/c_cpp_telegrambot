...
struct RegexHandlerBase {
    ...
    virtual void onRegexCreationFailed(const Message::Ptr& which, const std::string& what,
                                       const std::regex_error& why) {
        onRegexOperationFailed(which, why);
    }
    virtual void onRegexOperationFailed(const Message::Ptr& which,
                                        const std::regex_error& why) {}
    virtual void onRegexProcessed(const Message::Ptr& from, const std::string& processedData) {}
   ...
   private:
    ...
    OptionalWrapper<std::string> doRegexReplaceCommand(const Message::Ptr& regexCommand, const std::string& text);
    OptionalWrapper<std::string> doRegexDeleteCommand(const Message::Ptr& regexCommand, const std::string& text);
};
...
struct RegexHandler : public RegexHandlerBase {
    ...
    void onRegexCreationFailed(const Message::Ptr& which, const std::string& what, const std::regex_error& why) override;
    void onRegexOperationFailed(const Message::Ptr& which, const std::regex_error& why) override;
    void onRegexProcessed(const Message::Ptr& from, const std::string& processedData) override;
