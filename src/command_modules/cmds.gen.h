...
inline const std::vector gCmdModules = {
    &cmd_addblacklist, &cmd_rmblacklist, &cmd_addwhitelist, &cmd_rmwhitelist,
    &cmd_bash,         &cmd_unsafebash,  &cmd_alive,        &cmd_flash,
    &cmd_possibility,  &cmd_decide,      &cmd_delay,        &cmd_decho,
    &cmd_randsticker,  &cmd_fileid,      &cmd_starttimer,   &cmd_stoptimer,
    &cmd_saveid,       &cmd_start,
};
