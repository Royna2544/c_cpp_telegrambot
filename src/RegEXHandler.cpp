...
static std::optional<std::string> doRegexReplaceCommand(const Bot& bot, const Message::Ptr& msg) {
    std::regex src;
    std::string dest;
...
static std::optional<std::string> doRegexDeleteCommand(const Bot& bot, const Message::Ptr& msg) {
